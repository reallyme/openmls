...
#[test]
fn complete_xwing_aes256_ed25519_mls_flow() {
    complete_mls_flow(Ciphersuite::MLS_128_MLKEM768X25519_AES256GCM_SHA384_Ed25519);
}

#[test]
fn complete_mlkem768_ml_dsa_65_mls_flow() {
    complete_mls_flow(Ciphersuite::MLS_192_MLKEM768_AES256GCM_SHA384_MLDSA65);
}
