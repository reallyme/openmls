...
use reallyme_crypto::ml_dsa_65::{
    generate_ml_dsa_65_keypair, sign_ml_dsa_65, verify_ml_dsa_65, ML_DSA_65_PUBLIC_KEY_LEN,
...
impl OpenMlsCrypto for CryptoProvider {
    ...
    fn signature_key_gen(
        ...
        match algorithm {
            ...
            #[cfg(feature = "draft-ietf-mls-pq-ciphersuites")]
            SignatureScheme::MLDSA65 => generate_ml_dsa_65_keypair()
    ...
    fn verify_signature(
        ...
        match algorithm {
            ...
            SignatureScheme::MLDSA65 => {
                ...
                verify_ml_dsa_65(public_key, data, signature)
                    .map_err(|_| CryptoError::InvalidSignature)
            }
            #[cfg(feature = "draft-ietf-mls-pq-ciphersuites")]
    ...
    fn sign(
        ...
        match algorithm {
            ...
            #[cfg(feature = "draft-ietf-mls-pq-ciphersuites")]
            SignatureScheme::MLDSA65 => {
                if key.len() != ML_DSA_65_SECRET_SEED_LEN {
                    return Err(CryptoError::InvalidLength);
                }
                sign_ml_dsa_65(key, data).map_err(|_| CryptoError::SigningError)
            }
            #[cfg(feature = "draft-ietf-mls-pq-ciphersuites")]
            SignatureScheme::MLDSA87 => {
